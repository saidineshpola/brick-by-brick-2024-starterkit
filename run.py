...
if __name__ == "__main__":
    ...
    parser.add_argument("--label_len", type=int, default=94, help="start token length")
    parser.add_argument(
        "--pred_len", type=int, default=94, help="prediction sequence length"
    )
    parser.add_argument(
    ...
    parser.add_argument("--num_class", type=int, help="num of classes")
    # New Args for test
    # parser.add_argument(
    #     "--test_data_dir",
    #     type=str,
    #     default="/data1/max/telugu_corpus/time_series/test_X/",
